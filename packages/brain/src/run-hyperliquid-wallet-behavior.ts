...
} from './intelligence/hyperliquid/client.js'
import {
...
} from './intelligence/hyperliquid/wallet-profile.js'
...
async function main(): Promise<void> {
  ...
  const artifact: WalletBehaviorArtifact = {
    ...
    notes: [
      'Wallet behavior leads are research inputs only. No Supabase writes and no published narratives were created.',
