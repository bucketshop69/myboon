  ...
  return (
    <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      >
        ...
        >
          The narrative moves.{' '}
          <span className="text-primary">You move with it.</span>
        </motion.h1>
        <motion.p
          variants={fadeUp}
          className="text-sm text-on-surface-variant max-w-lg mx-auto leading-relaxed"
        >
          myboon catches market narratives before they move prices — then lets you act on them. Signals to trades. One app.
        </motion.p>
      </motion.div>
      ...
      <motion.div
        ...
        className="mt-6 z-40 flex items-center gap-4"
      >
        <a
          href="https://x.com/myboonapp"
          target="_blank"
          rel="noopener noreferrer"
          className="px-6 py-3 bg-gradient-to-br from-primary to-primary-container text-on-primary font-headline font-bold rounded-xl shadow-2xl shadow-primary/20 hover:scale-105 transition-all flex items-center gap-2 group"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="px-5 py-3 border border-outline-variant text-on-surface-variant font-headline text-sm rounded-xl hover:border-primary hover:text-primary transition-all flex items-center gap-2"
        >
          <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
